...
function DeleteTaskForm() {
  ...
  const handleDelete = () => {
    dispatch(deleteTask({ taskId: currentTask._id, projectId: currentTask.project }));
    dispatch(resetModal());
  };

  return (
    <div>
      <h3 className="text-lg font-medium leading-6 text-slate-900">Are you sure you want to delete this task?</h3>
